...
每天提交 10 个左右，在 GSC → URL检查 → 请求编入索引。
提交完一批后在对应行打 `[x]`。
...
## 批次 1 — 已完成（约11个）
- [x] `/`
- [x] `/arena/arena-1` 到 `/arena/arena-10`（推测）

---

## 批次 2（今天 — 完成剩余 Arena 页面）
- [x] `/arena/arena-11`
- [x] `/arena/arena-12`
- [x] `/arena/arena-13`
- [x] `/arena/arena-14`
...
## 批次 3（Hog Rider + Giant + Valkyrie 热门卡起步）
- [x] `/arena/arena-6/hog-rider`
- [x] `/arena/arena-7/hog-rider`
